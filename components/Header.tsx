      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <nav className="flex gap-6 text-sm font-bold text-slate-500">
            <Link href="/" className={`transition-colors ${isActive('/') ? 'text-primary' : 'hover:text-primary'}`}>Features</Link>
            <Link href="/about" className={`transition-colors ${isActive('/about') ? 'text-primary' : 'hover:text-primary'}`}>About Us</Link>
            <Link href="/pricing" className={`transition-colors ${isActive('/pricing') ? 'text-primary' : 'hover:text-primary'}`}>Pricing</Link>
            <Link href="/docs" className={`transition-colors ${isActive('/docs') ? 'text-primary' : 'hover:text-primary'}`}>User Guide</Link>
          </nav>
          <Link 
            href="/pricing"
